export const autoImportElementExample = `<template>
...
// ✅ 無需手動導入，插件自動識別 ElementPlus 組件
// import { ElForm, ElFormItem, ElInput... } from 'element-plus' ← 自動添加
// import { ref } from 'vue' ← 自動添加
// import type { FormInstance, FormRules } from 'element-plus' ← 自動添加
